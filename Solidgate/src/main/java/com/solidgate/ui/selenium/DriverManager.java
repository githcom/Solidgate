...
import static com.solidgate.ui.pageobjects.BasePage.getTimeoutSeconds;
...
public class DriverManager {
    ...
    private WebDriver createLocalDriver() {
        ...
        var service = new ChromeDriverService.Builder().usingDriverExecutable(
                new File("/PATH_TO_YOUR/chromedriver")).build();
        var chromeDriver = new ChromeDriver(service);
        chromeDriver.manage().window().maximize();
        chromeDriver.manage().timeouts().implicitlyWait(Duration.ofSeconds(getTimeoutSeconds()));
