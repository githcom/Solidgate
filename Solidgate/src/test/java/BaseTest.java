...
public class BaseTest {
    ...
    protected static TestConfig сonfig;
    ...
    @BeforeAll
    static void setup() {
        сonfig = ConfigCache.getOrCreate(TestConfig.class);
        PAYMENT_PAGE_URL = String.format("%s/%s", сonfig.hostUrl(),
                сonfig.onetimePageEndpoint());
